  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        voice: "bg-gradient-hero text-primary-foreground shadow-voice hover:scale-105 transform transition-all duration-300",
        voiceActive: "bg-voice-active text-white shadow-voice animate-pulse",
        success: "bg-success text-success-foreground shadow-elegant hover:bg-success/90",
        warning: "bg-warning text-warning-foreground shadow-elegant hover:bg-warning/90",
      },
      size: {
